...
<div class="w3-container w3-teal w3-opacity w3-left-align front-size:20px">
    ...
    <div class="w3-container w3-right">
    	<ul>
    		<li><a href="?locale=en"><fmt:message key="language.en" /></a></li>
    		<li><a href="?locale=ru"><fmt:message key="language.ru" /></a></li>
    	</ul>
...
<div class="w3-container w3-right-align">
    <p> <div class="w3-bar w3-padding-large w3-padding-24">
            <button class="w3-button w3-teal w3-round-large w3-left" onclick="location.href='/cinema/adminaction'">
                 ...
                 <fmt:message key="adminupdate.button"/></button>
                       <div id="id01" class="w3-modal">
                           <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
                                ...
                                <form class="w3-container" method="POST" action="/cinema/adminupdate">
...
<div class="w3-container w3-center">
    <footer class="w3-container w3-teal w3-round-large" style="width:100% ">
        <h4><b><fmt:message key="adminCabinet"/></b></h4>
    </footer>
</div>
...
<form class="w3-container w3-card-4 w3-light-grey w3-text-teal" style="width:50%;margin:auto">
     <div class="w3-row w3-section w3-left-align">
        ...
        </div><h3><b><c:out value="${admin.administratorName}"/>&nbsp<c:out value="${admin.administratorSurname}"/></b></h3>
        </p>
     </div>
    ...
    <div class="w3-row w3-section w3-left-align">
        ...
        </div><h3><b><c:out value="${admin.administratorEMailAddress}"/></b></h3>
        </p>
    </div>

     <div class="w3-row w3-section w3-left-align">
            <h4><b><fmt:message key="admin.work"/></b></h4>
            <p><div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-search">&nbsp</i>
            </div><h3><b><c:out value="${admin.administratorWorkingHoursPerWeek}"/></b></h3>
            </p>
        </div>
    ...
    <div class="w3-row w3-section w3-left-align">
        ...
        </div><h3><b><c:out value="${admin.gender}"/></b></h3>
    </div>
 </form>
